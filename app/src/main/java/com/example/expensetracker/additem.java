...
//            @Override
//            public void onClick(View view) {
//                Intent intent = new Intent(getApplicationContext(), monthly_expense.class);
...
//        todayItemsAdapter = new TodayItemsAdapter(additem.this, myDataList);
...
//                    totalAmount+=pTotal;
//
//                    amountTxtview.setText("Total Expense - $"+totalAmount);
//
//                }
//
//            }
...
//                    Toast.makeText(additem.this, "Please select a valid item", Toast.LENGTH_SHORT).show();
//                }
//                else {
