...
public class MainActivity extends AppCompatActivity {
    ...
    private CardView budgetCardView, todayCardView, weekCardView, monthCardView, historyCardView;

    private ImageView weekBtnImageView, todayBtnImageView, monthBtnImageView, analyticsImageView, budgetBtnImageView, historybtn ;
    ...
    private int totalAmountBudgetA = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        budgetBtnImageView = findViewById(R.id.homeBtnImageView);
